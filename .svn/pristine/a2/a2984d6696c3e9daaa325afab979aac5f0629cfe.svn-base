...
Technology for personalized advertising
...
Höhere Besucherzahlen, mehr Umsatz und das bei geringen Marketingkosten: Für all das spricht die releva.nz-Technologie auf welche das Plugin zurückgreift.
Wir holen die verlorenen Besucher zurück in Deinen Online-Shop.
...
== Installation ==
1. Upload the pluging via the Plugins menu or search for the plugin via the Wordpress Plugin directory
2. Activate the plugin through the \'Plugins\' menu in WordPress
3. If not already done, register on https://releva.nz for an API Key
4. Enter received API Key (open releva.nz via the menu in the Wordpress Admin on the left)
